#!/usr/bin/env python3
"""
DMG creation and packaging module for Nxtscape Browser
"""
...
def package(ctx: BuildContext) -> bool:
    ...
    if create_dmg(app_path, dmg_path, "Nxtscape", pkg_dmg_path):
...
def create_dmg(app_path: Path, dmg_path: Path, volume_name: str = "Nxtscape",
